...
function HeroBlockView({ block }) {
  ...
  return /* @__PURE__ */ jsxs(BlockSection, { block, style: getHeroSectionStyle(block.minHeight), children: [
    /* @__PURE__ */ jsxs("div", { style: layout, children: [
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            block.title && /* @__PURE__ */ jsx("h1", { style: { margin: 0, fontSize: titleSize, lineHeight: 1.1, fontWeight: 700 }, children: block.title }),
            block.subtitle && /* @__PURE__ */ jsx("p", { style: { margin: 0, fontSize: subtitleSize, lineHeight: 1.7, opacity: 0.85 }, children: block.subtitle }),
            block.ctaText && block.ctaLink && /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "0.75rem" }, children: /* @__PURE__ */ jsx("a", { href: block.ctaLink, style: buttonStyle, children: block.ctaText }) }),
            block.variant === "stats" && block.stats && block.stats.length > 0 && /* @__PURE__ */ jsx(
              "ul",
              {
                style: {
                  listStyle: "none",
    ...
    block.variant === "carousel" && block.slides && block.slides.length > 0 && /* @__PURE__ */ jsxs("div", { style: { marginTop: "2rem", display: "grid", gap: "0.75rem" }, children: [
      /* @__PURE__ */ jsx("h3", { style: { margin: 0, fontSize: 18 }, children: "Slides" }),
      /* @__PURE__ */ jsx("ul", { style: { margin: 0, paddingLeft: "1.25rem" }, children: block.slides.map((slide) => /* @__PURE__ */ jsxs("li", { children: [
        slide.title && /* @__PURE__ */ jsx("strong", { children: slide.title }),
        slide.subtitle && /* @__PURE__ */ jsxs("span", { children: [
          " ",
          slide.subtitle
        ] })
      ] }, slide.id)) })
