...
function HeroBlockView({ block }) {
  ...
  const renderTextContent = (title, subtitle, ctaText, ctaLink, extraContent) => /* @__PURE__ */ jsxs(
    "div",
    {
      style: {
        ...textAlignStyle,
      ...
      children: [
        title && /* @__PURE__ */ jsx("h1", { style: { margin: 0, fontSize: titleSize, lineHeight: 1.1, fontWeight: 700 }, children: title }),
        subtitle && /* @__PURE__ */ jsx("p", { style: { margin: 0, fontSize: subtitleSize, lineHeight: 1.7, opacity: 0.85 }, children: subtitle }),
        ctaText && ctaLink && /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "0.75rem", justifyContent: textAlign }, children: /* @__PURE__ */ jsx("a", { href: ctaLink, style: buttonStyle, children: ctaText }) }),
        extraContent
      ]
    }
  );
    ...
    return /* @__PURE__ */ jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { position: "relative", zIndex: 1, width: "100%", padding: "4rem 1rem" }, children: /* @__PURE__ */ jsx("div", { style: { ...contentMaxWidth }, children: renderTextContent(block.title, block.subtitle, block.ctaText, block.ctaLink) }) })
        ]
      }
    );
  }
  if (block.variant === "video") {
    ...
    return /* @__PURE__ */ jsxs(
      "section",
      {
        ...
        children: [
          block.videoUrl && !isEmbed && /* @__PURE__ */ jsx(
            "video",
            {
              autoPlay: true,
              muted: true,
              ...
              children: /* @__PURE__ */ jsx("source", { src: block.videoUrl, type: "video/mp4" })
            }
          ),
          block.videoUrl && isEmbed && /* @__PURE__ */ jsx(
            "div",
          ...
          /* @__PURE__ */ jsx("div", { style: { position: "relative", zIndex: 2, width: "100%", padding: "4rem 1rem" }, children: /* @__PURE__ */ jsx("div", { style: { ...contentMaxWidth }, children: renderTextContent(block.title, block.subtitle, block.ctaText, block.ctaLink) }) })
        ]
      }
    );
  }
  if (block.variant === "split") {
    ...
    return /* @__PURE__ */ jsx(BlockSection, { block, style: getHeroSectionStyle(minHeight), children: /* @__PURE__ */ jsxs(
      "div",
      {
        style: {
          display: "grid",
        ...
        children: [
          showImageFirst && block.imageUrl && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("img", { src: block.imageUrl, alt: block.title ?? "", style: imageStyle }) }),
  ...
  if (block.variant === "stats") {
    const statsContent = block.stats && block.stats.length > 0 && /* @__PURE__ */ jsx(
      "ul",
      {
        style: {
          listStyle: "none",
        ...
        children: block.stats.map((stat) => /* @__PURE__ */ jsxs(
          "li",
          {
            style: {
              borderRadius: 12,
            ...
            children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 22, fontWeight: 700 }, children: stat.value }),
              /* @__PURE__ */ jsx("div", { style: { fontSize: 12, letterSpacing: 0.3, textTransform: "uppercase", opacity: 0.8 }, children: stat.label })
            ]
          },
          stat.id
        ))
    ...
    return /* @__PURE__ */ jsx(BlockSection, { block, style: getHeroSectionStyle(minHeight), children: /* @__PURE__ */ jsx("div", { style: { display: "grid", gap: "1.75rem" }, children: renderTextContent(block.title, block.subtitle, block.ctaText, block.ctaLink, statsContent) }) });
  }
  return /* @__PURE__ */ jsx(BlockSection, { block, style: getHeroSectionStyle(minHeight), children: /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: "1.75rem" }, children: [
    renderTextContent(block.title, block.subtitle, block.ctaText, block.ctaLink),
    block.imageUrl && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("img", { src: block.imageUrl, alt: block.title ?? "", style: imageStyle }) })
  ] }) });
}
function TextBlockView({ block }) {
  const align = block.alignment ?? "start";
  return /* @__PURE__ */ jsx(BlockSection, { block, children: /* @__PURE__ */ jsxs("div", { style: { textAlign: align, maxWidth: 760, margin: "0 auto" }, children: [
    block.heading && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.heading }),
    block.body && /* @__PURE__ */ jsx("p", { style: subheadingStyle, children: block.body })
  ] }) });
}
function StatsBlockView({ block }) {
  const columns = Math.max(1, block.columns ?? 3);
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.heading && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.heading }),
    block.description && /* @__PURE__ */ jsx("p", { style: subheadingStyle, children: block.description }),
    block.cards && block.cards.length > 0 && /* @__PURE__ */ jsx(
      "div",
      {
        style: {
          display: "grid",
        ...
        children: block.cards.map((card) => /* @__PURE__ */ jsxs("div", { style: cardStyle, children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 24, fontWeight: 700 }, children: card.value }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: 13, textTransform: "uppercase", letterSpacing: 0.4, opacity: 0.7 }, children: card.label })
        ] }, card.id))
      }
    )
  ] });
...
function ImageBlockView({ block }) {
  return /* @__PURE__ */ jsx(BlockSection, { block, children: block.imageUrl && /* @__PURE__ */ jsxs("figure", { children: [
    /* @__PURE__ */ jsx("img", { src: block.imageUrl, alt: block.altText ?? "", style: imageStyle }),
    block.caption && /* @__PURE__ */ jsx("figcaption", { style: { marginTop: "0.75rem", fontSize: 13, opacity: 0.75 }, children: block.caption })
  ] }) });
}
function FaqBlockView({ block }) {
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
    block.items && block.items.length > 0 && /* @__PURE__ */ jsx("div", { style: { display: "grid", gap: "0.75rem" }, children: block.items.map((item) => /* @__PURE__ */ jsxs("details", { style: { ...cardStyle, padding: "0.75rem 1rem" }, children: [
      /* @__PURE__ */ jsx("summary", { style: { cursor: "pointer", fontWeight: 600 }, children: item.question }),
      /* @__PURE__ */ jsx("p", { style: { marginTop: "0.5rem", marginBottom: 0 }, children: item.answer })
    ] }, item.id)) })
  ] });
}
function SplitBlockView({ block }) {
  const imageFirst = block.imagePosition !== "right";
  return /* @__PURE__ */ jsx(BlockSection, { block, children: /* @__PURE__ */ jsxs(
    "div",
    {
      style: {
        display: "grid",
      ...
      children: [
        imageFirst && block.imageUrl && /* @__PURE__ */ jsx("img", { src: block.imageUrl, alt: block.title ?? "", style: imageStyle }),
        /* @__PURE__ */ jsxs("div", { children: [
          block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
          block.text && /* @__PURE__ */ jsx("p", { style: subheadingStyle, children: block.text }),
          block.ctaText && block.ctaLink && /* @__PURE__ */ jsx("a", { href: block.ctaLink, style: buttonStyle, children: block.ctaText })
        ] }),
        !imageFirst && block.imageUrl && /* @__PURE__ */ jsx("img", { src: block.imageUrl, alt: block.title ?? "", style: imageStyle })
      ]
    }
...
function GalleryBlockView({ block }) {
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
    block.images && block.images.length > 0 && /* @__PURE__ */ jsx(
      "div",
      {
        style: {
          display: "grid",
        ...
        children: block.images.map((image) => /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx("img", { src: image.url, alt: image.caption ?? "", style: { ...imageStyle, height: 180 } }),
          image.caption && /* @__PURE__ */ jsx("figcaption", { style: { marginTop: "0.5rem", fontSize: 13, opacity: 0.75 }, children: image.caption })
        ] }, image.id))
      }
    )
  ] });
...
function TestimonialCard({ item }) {
  return /* @__PURE__ */ jsxs("figure", { style: cardStyle, children: [
    item.quote && /* @__PURE__ */ jsx("blockquote", { style: { margin: 0, fontSize: 16, lineHeight: 1.6 }, children: item.quote }),
    /* @__PURE__ */ jsxs("figcaption", { style: { display: "flex", alignItems: "center", gap: "0.75rem", marginTop: "1rem" }, children: [
      item.photo && /* @__PURE__ */ jsx(
        "img",
        {
          src: item.photo,
          alt: item.name ?? "",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        item.name && /* @__PURE__ */ jsx("strong", { style: { display: "block" }, children: item.name }),
        item.role && /* @__PURE__ */ jsx("span", { style: { fontSize: 13, opacity: 0.7 }, children: item.role })
      ] })
    ] })
  ] });
}
function TestimonialsBlockView({ block }) {
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
    block.items && block.items.length > 0 && /* @__PURE__ */ jsx(
      "div",
      {
        style: {
          display: "grid",
        ...
        children: block.items.map((item) => /* @__PURE__ */ jsx(TestimonialCard, { item }, item.id))
      }
    )
  ] });
}
function CtaBlockView({ block }) {
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
    block.text && /* @__PURE__ */ jsx("p", { style: subheadingStyle, children: block.text }),
    block.buttonText && block.buttonLink && /* @__PURE__ */ jsx("a", { href: block.buttonLink, style: buttonStyle, children: block.buttonText })
  ] });
}
function IconListBlockView({ block }) {
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
    block.items && block.items.length > 0 && /* @__PURE__ */ jsx("ul", { style: { listStyle: "none", padding: 0, margin: 0, display: "grid", gap: "0.75rem" }, children: block.items.map((item) => /* @__PURE__ */ jsxs("li", { style: { display: "flex", alignItems: "flex-start", gap: "0.75rem" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        item.label && /* @__PURE__ */ jsx("strong", { style: { display: "block" }, children: item.label }),
        item.text && /* @__PURE__ */ jsx("span", { style: { fontSize: 14, opacity: 0.8 }, children: item.text })
      ] })
    ] }, item.id)) })
  ] });
}
function TimelineBlockView({ block }) {
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
    block.steps && block.steps.length > 0 && /* @__PURE__ */ jsx("ol", { style: { margin: 0, paddingLeft: "1.25rem", display: "grid", gap: "0.75rem" }, children: block.steps.map((step) => /* @__PURE__ */ jsxs("li", { children: [
      step.title && /* @__PURE__ */ jsx("strong", { children: step.title }),
      step.description && /* @__PURE__ */ jsx("p", { style: { marginTop: "0.35rem", marginBottom: 0 }, children: step.description })
    ] }, step.id)) })
  ] });
}
function VideoBlockView({ block }) {
  return /* @__PURE__ */ jsxs(BlockSection, { block, children: [
    block.title && /* @__PURE__ */ jsx("h2", { style: headingStyle, children: block.title }),
    block.videoUrl && /* @__PURE__ */ jsx("div", { style: { position: "relative", paddingBottom: "56.25%", height: 0 }, children: /* @__PURE__ */ jsx(
      "iframe",
      {
        src: block.videoUrl,
    ...
    block.caption && /* @__PURE__ */ jsx("p", { children: block.caption })
  ] });
}
function DividerBlockView({ block }) {
  return /* @__PURE__ */ jsx("div", { style: { ...sectionBaseStyle, ...getBlockStyle(block) }, children: /* @__PURE__ */ jsx(
    "hr",
    {
      style: {
...
function SpacerBlockView({ block }) {
  return /* @__PURE__ */ jsx("div", { style: { height: block.height ?? 24 } });
}
function renderComposedData(data) {
  switch (data.preset) {
    case "introCards":
      return /* @__PURE__ */ jsxs("div", { children: [
        data.title && /* @__PURE__ */ jsx("h2", { children: data.title }),
        data.intro && /* @__PURE__ */ jsx("p", { children: data.intro }),
        data.cards && /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem" }, children: data.cards.map((card) => /* @__PURE__ */ jsxs("div", { children: [
          card.icon && /* @__PURE__ */ jsx("div", { children: card.icon }),
          card.title && /* @__PURE__ */ jsx("strong", { children: card.title }),
          card.text && /* @__PURE__ */ jsx("p", { children: card.text })
        ] }, card.id)) })
      ] });
    case "imageTextCta":
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            data.imagePosition !== "right" && data.imageUrl && /* @__PURE__ */ jsx("img", { src: data.imageUrl, alt: data.title ?? "", style: { width: "100%" } }),
            /* @__PURE__ */ jsxs("div", { children: [
              data.title && /* @__PURE__ */ jsx("h2", { children: data.title }),
              data.text && /* @__PURE__ */ jsx("p", { children: data.text }),
              data.ctaText && data.ctaLink && /* @__PURE__ */ jsx("a", { href: data.ctaLink, style: buttonStyle, children: data.ctaText })
            ] }),
            data.imagePosition === "right" && data.imageUrl && /* @__PURE__ */ jsx("img", { src: data.imageUrl, alt: data.title ?? "", style: { width: "100%" } })
          ]
        }
    ...
    case "statsCta":
      return /* @__PURE__ */ jsxs("div", { children: [
        data.title && /* @__PURE__ */ jsx("h2", { children: data.title }),
        data.text && /* @__PURE__ */ jsx("p", { children: data.text }),
        data.stats && /* @__PURE__ */ jsx("ul", { children: data.stats.map((stat) => /* @__PURE__ */ jsxs("li", { children: [
          /* @__PURE__ */ jsx("strong", { children: stat.value }),
          " ",
          stat.label
        ] }, stat.id)) }),
        data.ctaText && data.ctaLink && /* @__PURE__ */ jsx("a", { href: data.ctaLink, style: buttonStyle, children: data.ctaText })
    ...
    case "faqCta":
      return /* @__PURE__ */ jsxs("div", { children: [
        data.title && /* @__PURE__ */ jsx("h2", { children: data.title }),
        data.items && /* @__PURE__ */ jsx("div", { children: data.items.map((item) => /* @__PURE__ */ jsxs("details", { children: [
    ...
    case "testimonialsRating":
      return /* @__PURE__ */ jsxs("div", { children: [
        data.title && /* @__PURE__ */ jsx("h2", { children: data.title }),
        data.ratingLabel && data.ratingValue && /* @__PURE__ */ jsxs("p", { children: [
          data.ratingLabel,
          ": ",
          /* @__PURE__ */ jsx("strong", { children: data.ratingValue })
        ] }),
        data.ratingText && /* @__PURE__ */ jsx("p", { children: data.ratingText }),
        data.items && /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1rem" }, children: data.items.map((item) => /* @__PURE__ */ jsx(TestimonialCard, { item }, item.id)) })
      ] });
    case "galleryText":
      return /* @__PURE__ */ jsxs("div", { children: [
        data.title && /* @__PURE__ */ jsx("h2", { children: data.title }),
        data.text && /* @__PURE__ */ jsx("p", { children: data.text }),
        data.images && /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1rem" }, children: data.images.map((image) => /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx("img", { src: image.url, alt: image.caption ?? "", style: { width: "100%" } }),
          image.caption && /* @__PURE__ */ jsx("figcaption", { children: image.caption })
        ] }, image.id)) })
      ] });
    default:
      return null;
...
function ComposedBlockView({ block }) {
  ...
  return /* @__PURE__ */ jsx(BlockSection, { block, children: renderComposedData(block.data) });
}
...
function PageBuilderRenderer({
  ...
  return /* @__PURE__ */ jsx2(Wrapper, { children: blocks.map((block) => {
...
function BlockIcon({ type, size = 20, color = "#64748b" }) {
  switch (type) {
    case "hero":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("rect", { x: "3", y: "4", width: "18", height: "16", rx: "2", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3("rect", { x: "6", y: "7", width: "12", height: "10", rx: "1", stroke: color, strokeWidth: "1.5", fill: "none" })
      ] });
    case "text":
      return /* @__PURE__ */ jsx3("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: /* @__PURE__ */ jsx3(
        "path",
        {
    ...
    case "stats":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("rect", { x: "3", y: "17", width: "4", height: "4", rx: "1", fill: color }),
        /* @__PURE__ */ jsx3("rect", { x: "10", y: "13", width: "4", height: "8", rx: "1", fill: color }),
        /* @__PURE__ */ jsx3("rect", { x: "17", y: "9", width: "4", height: "12", rx: "1", fill: color })
      ] });
    case "image":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3("circle", { cx: "8.5", cy: "8.5", r: "1.5", fill: color }),
        /* @__PURE__ */ jsx3("path", { d: "M21 15l-5-5L5 21", stroke: color, strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
      ] });
    case "faq":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("circle", { cx: "12", cy: "12", r: "10", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3(
          "path",
          {
    ...
    case "split":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("rect", { x: "3", y: "4", width: "9", height: "16", rx: "1", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3("rect", { x: "12", y: "4", width: "9", height: "16", rx: "1", stroke: color, strokeWidth: "2", fill: "none" })
      ] });
    case "gallery":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("rect", { x: "3", y: "3", width: "7", height: "7", rx: "1", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3("rect", { x: "14", y: "3", width: "7", height: "7", rx: "1", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3("rect", { x: "3", y: "14", width: "7", height: "7", rx: "1", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3("rect", { x: "14", y: "14", width: "7", height: "7", rx: "1", stroke: color, strokeWidth: "2", fill: "none" })
      ] });
    case "testimonials":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3(
    ...
    case "iconList":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("circle", { cx: "12", cy: "12", r: "3", fill: color }),
        /* @__PURE__ */ jsx3("circle", { cx: "12", cy: "5", r: "2", fill: color }),
        /* @__PURE__ */ jsx3("circle", { cx: "12", cy: "19", r: "2", fill: color })
      ] });
    case "timeline":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("circle", { cx: "12", cy: "5", r: "2", fill: color }),
        /* @__PURE__ */ jsx3("circle", { cx: "12", cy: "12", r: "2", fill: color }),
        /* @__PURE__ */ jsx3("circle", { cx: "12", cy: "19", r: "2", fill: color }),
        /* @__PURE__ */ jsx3("line", { x1: "12", y1: "7", x2: "12", y2: "10", stroke: color, strokeWidth: "2" }),
        /* @__PURE__ */ jsx3("line", { x1: "12", y1: "14", x2: "12", y2: "17", stroke: color, strokeWidth: "2" })
      ] });
    case "video":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("rect", { x: "2", y: "6", width: "18", height: "12", rx: "2", stroke: color, strokeWidth: "2", fill: "none" }),
        /* @__PURE__ */ jsx3("path", { d: "M10 10l4 2-4 2v-4z", fill: color })
      ] });
    case "divider":
      return /* @__PURE__ */ jsx3("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: /* @__PURE__ */ jsx3("line", { x1: "3", y1: "12", x2: "21", y2: "12", stroke: color, strokeWidth: "2", strokeLinecap: "round" }) });
    case "spacer":
      return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: [
        /* @__PURE__ */ jsx3("line", { x1: "12", y1: "2", x2: "12", y2: "22", stroke: color, strokeWidth: "2", strokeLinecap: "round" }),
        /* @__PURE__ */ jsx3("path", { d: "M8 6l4-4 4 4M8 18l4 4 4-4", stroke: color, strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
      ] });
    default:
      return /* @__PURE__ */ jsx3("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", style: iconStyle, children: /* @__PURE__ */ jsx3("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2", stroke: color, strokeWidth: "2", fill: "none" }) });
  }
}
...
function LanguageTabs({
  ...
  return /* @__PURE__ */ jsx4("div", { style: { display: "flex", gap: 4, marginBottom: 8 }, children: languages.map((lang) => /* @__PURE__ */ jsx4(
    "button",
    {
      type: "button",
...
function ImageUploadField({
  ...
  return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 8 }, children: [
    /* @__PURE__ */ jsx4(FieldLabel, { children: label }),
    preview && /* @__PURE__ */ jsxs3("div", { style: { position: "relative", width: "100%" }, children: [
      /* @__PURE__ */ jsx4(
        "img",
        {
          src: preview,
...
function DragHandle() {
  return /* @__PURE__ */ jsx4("div", { style: { cursor: "grab", display: "flex", gap: 2, padding: "0.25rem" }, children: /* @__PURE__ */ jsxs3("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: [
    /* @__PURE__ */ jsx4("circle", { cx: "2", cy: "2", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "6", cy: "2", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "10", cy: "2", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "2", cy: "6", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "6", cy: "6", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "10", cy: "6", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "2", cy: "10", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "6", cy: "10", r: "1", fill: "#94a3b8" }),
    /* @__PURE__ */ jsx4("circle", { cx: "10", cy: "10", r: "1", fill: "#94a3b8" })
  ] }) });
}
function EyeIcon({ visible }) {
  if (visible) {
    return /* @__PURE__ */ jsxs3("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
...
function BlockEditor({
  ...
  const renderCommon = () => /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 12 }, children: [
    ...
    block.backgroundType === "solid" && /* @__PURE__ */ jsx4(
      ColorField,
      {
        label: "Couleur",
    ...
    block.backgroundType === "gradient" && /* @__PURE__ */ jsx4(
      GradientField,
      {
        label: "Gradient",
    ...
    block.backgroundType === "image" && /* @__PURE__ */ jsx4(
      ImageUploadField,
      {
        label: "Image de fond",
  ...
  switch (block.type) {
    case "hero": {
      ...
      return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 16 }, children: [
        ...
        (hero.variant === "split" || hero.variant === "cover" || hero.variant === "simple") && /* @__PURE__ */ jsxs3(Fragment3, { children: [
          ...
          hero.variant === "split" && /* @__PURE__ */ jsx4(
            SelectField,
            {
        ...
        (hero.variant === "video" || hero.variant === "cover") && /* @__PURE__ */ jsx4(
          TextField,
          {
            label: "URL Vid\xE9o",
            value: hero.videoUrl,
        ...
        hero.variant === "stats" && /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 8 }, children: [
          /* @__PURE__ */ jsx4(SectionTitle, { children: "Stats" }),
          hero.stats && hero.stats.length > 0 && /* @__PURE__ */ jsx4("div", { style: { display: "grid", gap: 8 }, children: hero.stats.map((stat, index) => /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 6 }, children: [
            /* @__PURE__ */ jsx4(
              TextField,
              {
                label: "Label",
    ...
    case "stats": {
      ...
      return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 16 }, children: [
        ...
        /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 12 }, children: [
          /* @__PURE__ */ jsx4("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: /* @__PURE__ */ jsxs3(SectionTitle, { children: [
            "Cartes (",
            stats.cards?.length ?? 0,
            ")"
          ] }) }),
          stats.cards && stats.cards.length > 0 && /* @__PURE__ */ jsx4("div", { style: { display: "grid", gap: 8 }, children: stats.cards.map((card, index) => /* @__PURE__ */ jsxs3(
            "div",
            {
              style: {
                display: "flex",
    ...
    case "faq": {
      ...
      return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 16 }, children: [
        ...
        /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 8 }, children: [
          /* @__PURE__ */ jsx4(SectionTitle, { children: "Questions" }),
          faq.items?.map((item, index) => /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 6 }, children: [
            /* @__PURE__ */ jsx4(
              TextField,
              {
                label: "Question",
    ...
    case "gallery": {
      ...
      return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 16 }, children: [
        ...
        /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 8 }, children: [
          /* @__PURE__ */ jsx4(SectionTitle, { children: "Images" }),
          gallery.images?.map((item, index) => /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 6 }, children: [
            /* @__PURE__ */ jsx4(
              ImageUploadField,
              {
                label: "Image",
    ...
    case "testimonials": {
      ...
      return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 16 }, children: [
        ...
        /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 8 }, children: [
          /* @__PURE__ */ jsx4(SectionTitle, { children: "Temoignages" }),
          testimonials.items?.map((item, index) => /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 6 }, children: [
            /* @__PURE__ */ jsx4(
              TextField,
              {
                label: "Nom",
    ...
    case "iconList": {
      ...
      return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 16 }, children: [
        ...
        /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 8 }, children: [
          /* @__PURE__ */ jsx4(SectionTitle, { children: "Elements" }),
          iconList.items?.map((item, index) => /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 6 }, children: [
            /* @__PURE__ */ jsx4(
              TextField,
              {
                label: "Icone",
    ...
    case "timeline": {
      ...
      return /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 16 }, children: [
        ...
        /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 8 }, children: [
          /* @__PURE__ */ jsx4(SectionTitle, { children: "Etapes" }),
          timeline.steps?.map((step, index) => /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 6 }, children: [
            /* @__PURE__ */ jsx4(
              TextField,
              {
                label: "Titre",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs3("aside", { style: { display: "grid", gap: "1rem", alignContent: "start" }, children: [
          /* @__PURE__ */ jsxs3("div", { style: { display: "flex", gap: 4, marginBottom: "0.5rem" }, children: [
            /* @__PURE__ */ jsx4(
              "button",
              {
                type: "button",
          ...
          activeTab === "settings" && /* @__PURE__ */ jsxs3("div", { style: { ...panelStyle, display: "grid", gap: 16 }, children: [
            /* @__PURE__ */ jsx4(SectionTitle, { children: "Param\xE8tres de la page" }),
            /* @__PURE__ */ jsx4(
              TextField,
              {
            ...
            /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: 6 }, children: [
              /* @__PURE__ */ jsx4(FieldLabel, { children: "Date de publication" }),
              /* @__PURE__ */ jsx4(
                "input",
                {
                  type: "datetime-local",
          ...
          activeTab === "blocks" && /* @__PURE__ */ jsxs3("div", { style: { ...panelStyle, display: "grid", gap: 12 }, children: [
            /* @__PURE__ */ jsx4(SectionTitle, { children: "Ajouter un bloc" }),
            /* @__PURE__ */ jsx4("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 8 }, children: availableBlocks.map((type) => /* @__PURE__ */ jsxs3(
              "button",
              {
                type: "button",
                style: {
            ...
            (availableBlocks.includes("divider") || availableBlocks.includes("spacer")) && /* @__PURE__ */ jsxs3("div", { style: { display: "flex", flexDirection: "column", gap: 6, marginTop: 8 }, children: [
              availableBlocks.includes("divider") && /* @__PURE__ */ jsxs3(
                "button",
                {
                  type: "button",
              ...
              availableBlocks.includes("spacer") && /* @__PURE__ */ jsxs3(
                "button",
                {
                  type: "button",
                  ...
                  /* @__PURE__ */ jsxs3("div", { style: { display: "flex", gap: 4, alignItems: "center" }, children: [
                    /* @__PURE__ */ jsx4(
                      "button",
                      {
                        ...
                        children: /* @__PURE__ */ jsx4(EyeIcon, { visible: block.visible !== false })
                      }
                    ),
                    /* @__PURE__ */ jsx4(
                      "button",
                      {
                        ...
                        disabled: index === 0,
                        title: "D\xE9placer vers le haut",
                        children: /* @__PURE__ */ jsx4("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsx4("path", { d: "M18 15l-6-6-6 6" }) })
                      }
                    ),
                    /* @__PURE__ */ jsx4(
                      "button",
                      {
                        ...
                        title: "D\xE9placer vers le bas",
                        children: /* @__PURE__ */ jsx4("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsx4("path", { d: "M6 9l6 6 6-6" }) })
                      }
                    ),
                    /* @__PURE__ */ jsx4(
                      "button",
                      {
                        ...
                        title: "Supprimer",
                        children: /* @__PURE__ */ jsx4("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsx4("path", { d: "M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" }) })
                      }
                    )
                  ] })
                ]
        ...
        /* @__PURE__ */ jsxs3("main", { style: { display: "grid", gap: "1rem", alignContent: "start" }, children: [
          /* @__PURE__ */ jsxs3(
            "div",
            {
              style: {
