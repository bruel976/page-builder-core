...
function FieldLabel({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { style: { fontSize: 13, fontWeight: 600, color: "var(--pb-text)", fontFamily: "inherit" }, children });
}
...
function ImageUploadField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "grid", gap: 8 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "grid", gap: 6 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { style: { fontSize: 12, color: "var(--pb-text-muted)" }, children: "Ou entrer une URL" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "grid", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "grid", gap: 4 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { style: { fontSize: 12, color: "var(--pb-text-muted)" }, children: "Couleur 1" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "grid", gap: 4 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { style: { fontSize: 12, color: "var(--pb-text-muted)" }, children: "Couleur 2" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "input",
              {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "grid", gap: 6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { style: { fontSize: 12, color: "var(--pb-text-muted)" }, children: "Direction" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          SelectField,
          {
            label: "",
...
function SectionTitle({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { style: { margin: 0, fontSize: 14, fontWeight: 600, color: "var(--pb-text)", fontFamily: "inherit" }, children });
}
function DragHandle() {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("aside", { style: { display: "grid", gap: "1rem", alignContent: "start" }, children: [
          ...
          activeTab === "settings" && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { ...panelStyle, display: "grid", gap: 16 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "grid", gap: 12, paddingTop: 12, borderTop: "1px solid var(--pb-border)" }, children: [
          ...
          activeTab === "blocks" && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { ...panelStyle, display: "grid", gap: 12 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 8 }, children: availableBlocks.map((type) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockIcon, { type, size: 20, color: "var(--pb-text-muted)" }),
            ...
            (availableBlocks.includes("divider") || availableBlocks.includes("spacer")) && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6, marginTop: 8 }, children: [
              availableBlocks.includes("divider") && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockIcon, { type: "divider", size: 16, color: "var(--pb-text-muted)" }),
              ...
              availableBlocks.includes("spacer") && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockIcon, { type: "spacer", size: 16, color: "var(--pb-text-muted)" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { ...panelStyle, display: "grid", gap: 8 }, children: [
            ...
            blocks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0, fontSize: 13, color: "var(--pb-text-muted)", textAlign: "center", padding: "1rem 0" }, children: "Ajoute un bloc pour commencer." }),
            blocks.map((block, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DragHandle, {}),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockIcon, { type: block.type, size: 18, color: block.id === selectedId ? "var(--pb-primary)" : "var(--pb-text-muted)" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("main", { style: { display: "grid", gap: "1rem", alignContent: "start" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { style: { fontSize: 16, fontWeight: 600, color: "var(--pb-text)", fontFamily: "inherit" }, children: "Nouvelle page" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                    "button",
                    {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("aside", { style: { display: "grid", gap: "1rem", alignContent: "start" }, children: [
          selectedBlock && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { ...panelStyle, display: "grid", gap: 16 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockIcon, { type: selectedBlock.type, size: 20, color: "var(--pb-text)" }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { borderTop: "1px solid var(--pb-border)", paddingTop: 16 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              BlockEditor,
              {
                block: selectedBlock,
          ...
          !selectedBlock && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { ...panelStyle, display: "grid", gap: 12, textAlign: "center", padding: "2rem 1rem" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0, fontSize: 14, color: "var(--pb-text-muted)" }, children: "S\xE9lectionne un bloc pour modifier ses param\xE8tres." }) })
        ] })
      ]
    }
  );
